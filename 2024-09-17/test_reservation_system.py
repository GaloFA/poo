...
class TestReservationSystem(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.room_management.add_room("Sala 2", 20)

        self.system._rooms = self.room_management._rooms
        
        self.start_datetime = DateTime(20, 9, 2024, 14, 0, 0)
        self.end_datetime = DateTime(20, 9, 2024, 15, 0, 0)

    def test_01_hacer_reserva(self):
        self.system.make_reservation("Sala 1", self.start_datetime, self.end_datetime)
    ...
    def test_02_hacer_reserva_con_conflicto(self):
        ...
        with self.assertRaises(ValueError):
            ...
            self.system.make_reservation("Sala 1", overlapping_start, overlapping_end)
